 ...
 * from the specification file <tt>Russell.flex</tt>
 */
class RussellLexer implements FlexLexer {
   ...
   */
  RussellLexer(java.io.Reader in) {
    this.zzReader = in;
  }
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { yybegin(YYINITIAL); return RussellTypes.KEY;
            }
          case 8: break;
          case 2: 
          ...
          case 10: break;
          case 4: 
            { yybegin(YYINITIAL); return RussellTypes.COMMENT;
            }
          case 11: break;
          case 5: 
            { yybegin(WAITING_VALUE); return RussellTypes.SEPARATOR;
            }
          case 12: break;
          case 6: 
            { yybegin(YYINITIAL); return RussellTypes.VALUE;
            }
          case 13: break;
          case 7: 
