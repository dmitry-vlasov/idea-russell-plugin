...
public class MetamathEssentialImpl extends ASTWrapperPsiElement implements MetamathEssential {

  public MetamathEssentialImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MetamathVisitor visitor) {
    visitor.visitEssential(this);
  }
