...
public class MetamathFloatingImpl extends ASTWrapperPsiElement implements MetamathFloating {

  public MetamathFloatingImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MetamathVisitor visitor) {
    visitor.visitFloating(this);
  }
