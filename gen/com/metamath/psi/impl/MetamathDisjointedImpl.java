...
public class MetamathDisjointedImpl extends ASTWrapperPsiElement implements MetamathDisjointed {

  public MetamathDisjointedImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MetamathVisitor visitor) {
    visitor.visitDisjointed(this);
  }
